...
function closeNav() {
  ...
  <!--__________________________________________Search bar_____________________________--->
   <div class="container">
     <div class="srch">
    ...
    <?php
       ...
       {
          $q=mysqli_query($db,"SELECT username,bid,returned,day,fine,status FROM `fine`
 where username like '%$_POST[search]%' ");
     ...
     echo "<table class='table table-bordered table-hover' >";
      ...
      //Table header
        ...
        echo "<th>"; echo " Fines in Rupee ";    echo "</th>";
     ...
     echo "</table>";
       ...
       {
          $res=mysqli_query($db,"SELECT username,bid,returned,day,fine,status FROM `fine`;");
